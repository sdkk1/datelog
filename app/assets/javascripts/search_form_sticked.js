$(function($){
  var row = $(".row");
  var content = $(".content");
  var search_form_sticked = $(".search_form_sticked");

  // コンテンツの位置
  var content_top = content.offset().top;
  // 固定する要素の元々の位置
  var search_form_sticked_original_top = search_form_sticked.offset().top;
  // 固定する要素の高さ
  var search_form_sticked_height = search_form_sticked.height();
